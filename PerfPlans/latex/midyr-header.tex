...
\AddEverypageHook{%
   \ifthenelse{\value{page}=3}%
     {\rhead{\includegraphics[width=40pt]{images/NOAA_logo.png} \\ \textsf{\emph{17 April 2020}}}
      \lhead{\textsf{\LARGE Mid Year Performance Review: S.Gaichas}}
      }%
     {\rhead{}
      \lhead{\textsf{\emph{Mid Year Performance Review: S.Gaichas}}}
     }
}
