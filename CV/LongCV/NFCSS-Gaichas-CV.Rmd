...
Isaac C. Kaplan, Sarah K Gaichas, Christine C Stawitz, Patrick D. Lynch, Kristin N Marshall, Jonathan J. Deroba, Michelle Masi, Jon KT Brodziak, Kerim Y. Aydin, Kirstin Holsman, Howard Townsend, Desiree Tommasi, James A. Smith, Stefan Koenigstein, Mariska Weijerman and Jason Link. Management Strategy Evaluation: Allowing the Light on the Hill to Illuminate More than One Species. Original Research, Front. Mar. Sci. - Marine Fisheries, Aquaculture and Living Resources. Received on: 31 Oct 2020, Edited by: Athanassios C. Tsikliras. Manuscript ID: 624355
