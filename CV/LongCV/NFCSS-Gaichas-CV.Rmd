...
Deroba J.J., Gaichas S.K. (speaker), Lee M‐Y., Feeney R.G., Boelke D., Irwin B. Getting on the same page, or at least in the same library: lessons in communication from a stakeholder-driven MSE for Northeast US Atlantic herring. 2017 IMBER IMBIZO, Woods Hole MA. 
...
S.Gaichas, J. Link, J. Hare, M. Fogarty, P. Pinto da Silva, G. DePiper, J. Cournane, J. Manderson, S. Lucey, M. Lowe, S. Large, and G. Fay. Towards operational assessments: selection, vetting, and standardized analysis of ecosystem indicators for the Northeast US Large Marine Ecosystem. 2014 ICES Annual Science Conference, A Coruña, Spain.


•	2012 World Fisheries Congress, May (CAMEO Production modeling synthesis paper)
•	2012 AIFRB Symposium, June (Alaska “beer belly” paper)
•	2012 Ecologial Society of America Annual meeting, Portland OR August (Multispecies size structured spatial assessment model development)
...
Gaichas, S.,  What Drives Dynamics in the Gulf of Alaska? Integrating Hypotheses of Species, Fishing, and Climate Relationships Using Ecosystem Modeling. 2010 Lowell Wakefield Ecosystems Symposium, Anchorage AK.
